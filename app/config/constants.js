...
export const appDescription = "Carbon Footprint is an open-source project developed by AOSSIE (the Australian Open Source Software Innovation and Education association). This mobile application calculates amount of emitted co2 based on user's activity and traveled distance."
