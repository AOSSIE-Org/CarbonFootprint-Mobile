                        ...
                        <View style={columnStyle} key={i}>
                          <View style={styles.social}>
                            <Icon2
                              ...
                              onPress={() =>
                                this.ShareMessage(
                                  `I emitted ${column.value.footprint.toFixed(
                                    2
                                  )}  kg on ${
                                    column.icon
                                  } travelling a distance of ${column.value.distance.toFixed(
                                    2
                                  )} km in ${
                                    column.value.time
                                  }s. Analyse yours too, download the CarbonFootprint-Mobile app now.`
                                )
                              }
                            />
                          </View>
